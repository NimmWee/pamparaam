...
func NewSessionAuthorizer(checker *runtimeauthz.Client) *SessionAuthorizer {
	return &SessionAuthorizer{checker: checker}
}

func (a *SessionAuthorizer) Authorize(ctx context.Context, action authz.Action, subject AuthorizationSubject) error {
