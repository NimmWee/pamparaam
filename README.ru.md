...
Английская версия: [README.md](/C:/MTC/README.md)
...
Источник: [WikiLive feature template](</C:/MTC/WikiLive шаблон фич (2).xlsx>)
...
- RBAC:
  `Auth Service` - runtime authority для workspace/page grants; остальные сервисы спрашивают его по gRPC.
...
- Go 1.23+, если хочешь запускать сервисы и утилиты вне Docker
...
Если хочешь стандартную инициализацию одним шагом:
